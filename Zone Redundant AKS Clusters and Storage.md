...
![regions-availability-zones.png](./_images/Zone-Redundant-AKS-and-Storage/regions-availability-zones.png)
...
![locally-redundant-storage.png](./_images/Zone-Redundant-AKS-and-Storage/locally-redundant-storage.png)
...
![zone-redundant-storage.png](./_images/Zone-Redundant-AKS-and-Storage/zone-redundant-storage.png)
...
![architecture01.png](./_images/Zone-Redundant-AKS-and-Storage/architecture01.png)
...
![zone-redundant-node-pool-before.png](./_images/Zone-Redundant-AKS-and-Storage/zone-redundant-node-pool-before.png)
...
![zone-redundant-node-pool-after.png](./_images/Zone-Redundant-AKS-and-Storage/zone-redundant-node-pool-after.png)

The `lrs-nginx-*` ended up in a `Pending` status because the Kubernetes scheduler couldn't find a node where to run it. In fact, the pod needs to mount the LRS Azure disk, but there are no nodes in a `ready` status in the availability zone hosting the disk. Actually, there is a cluster node in this availability zone, but this node is part of the system-node pool that is tainted with `CriticalAddonsOnly=true:NoSchedule` and the pod doesn't have the necessary toleration for this taint. The following command can provide more information on why the pod ended up in a `Pending` status.
...
![architecture02.png](./_images/Zone-Redundant-AKS-and-Storage/architecture02.png)
...
![zonal-node-pools-before.png](./_images/Zone-Redundant-AKS-and-Storage/zonal-node-pools-before.png)
...
![zonal-node-pools-az-down.png](./_images/Zone-Redundant-AKS-and-Storage/zonal-node-pools-az-down.png)
...
![zonal-node-pools-after.png](./_images/Zone-Redundant-AKS-and-Storage/zonal-node-pools-after.png)
...
![zonal-node-pools-zrs-disk-before.png](./_images/Zone-Redundant-AKS-and-Storage/zonal-node-pools-zrs-disk-before.png)
...
![zonal-node-pools-zrs-disk-after.png](./_images/Zone-Redundant-AKS-and-Storage/zonal-node-pools-zrs-disk-after.png)
