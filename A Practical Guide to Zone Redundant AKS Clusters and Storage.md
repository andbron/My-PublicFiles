...
![regions-availability-zones.png](https://techcommunity.microsoft.com/t5/image/serverpage/image-id/544420i5F812ACAE9F4BAB9/image-size/large?v=v2&px=999 "regions-availability-zones.png")
...
![locally-redundant-storage.png](https://techcommunity.microsoft.com/t5/image/serverpage/image-id/544421i4342A4D7A62D2AF8/image-size/large?v=v2&px=999 "locally-redundant-storage.png")
...
![zone-redundant-storage.png](https://techcommunity.microsoft.com/t5/image/serverpage/image-id/544422i6C253A9291881985/image-size/large?v=v2&px=999 "zone-redundant-storage.png")
...
![architecture01.png](https://techcommunity.microsoft.com/t5/image/serverpage/image-id/544424i572A8787CB3D389E/image-size/large?v=v2&px=999 "architecture01.png")
...
![zone-redundant-node-pool-before.png](https://techcommunity.microsoft.com/t5/image/serverpage/image-id/544428iA4FE12B40C1F7E01/image-size/large?v=v2&px=999 "zone-redundant-node-pool-before.png")
...
![zone-redundant-node-pool-after.png](https://techcommunity.microsoft.com/t5/image/serverpage/image-id/544435i400301D1A1B35060/image-size/large?v=v2&px=999 "zone-redundant-node-pool-after.png")
...
![architecture02.png](https://techcommunity.microsoft.com/t5/image/serverpage/image-id/544444i5159AFE8F06C6294/image-size/large?v=v2&px=999 "architecture02.png")
...
You can opt-out a node group from being automatically balanced with other node groups using the same instance type by giving it any custom label. For more information, see [I'm running cluster with nodes in multiple zones for HA purposes. Is that supported by Cluster Autos...](https://github.com/kubernetes/autoscaler/blob/master/cluster-autoscaler/FAQ.md#im-running-cluster-with-nodes-in-multiple-zones-for-ha-purposes-is-that-supported-by-cluster-autoscaler)
...
![zonal-node-pools-before.png](https://techcommunity.microsoft.com/t5/image/serverpage/image-id/544473i96892C32F54C05BC/image-size/large?v=v2&px=999 "zonal-node-pools-before.png")
...
![zonal-node-pools-az-down.png](https://techcommunity.microsoft.com/t5/image/serverpage/image-id/544504i333034AAECD67A06/image-size/large?v=v2&px=999 "zonal-node-pools-az-down.png")
...
![zonal-node-pools-after.png](https://techcommunity.microsoft.com/t5/image/serverpage/image-id/544505i29C80CAE5F2AB746/image-size/large?v=v2&px=999 "zonal-node-pools-after.png")
...
![zonal-node-pools-zrs-disk-before.png](https://techcommunity.microsoft.com/t5/image/serverpage/image-id/545092iE12772740C9DF83E/image-size/large?v=v2&px=999 "zonal-node-pools-zrs-disk-before.png")
...
![zonal-node-pools-zrs-disk-after.png](https://techcommunity.microsoft.com/t5/image/serverpage/image-id/545096i043F5CABB0F37EBE/image-size/large?v=v2&px=999 "zonal-node-pools-zrs-disk-after.png")
